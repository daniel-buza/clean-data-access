...
import com.example.variation1.persistence.RelatedLibraryPersistenceProviderImpl;
import java.util.List;


@Slf4j
public class LibraryServiceTest_Variation1b extends LibraryServiceTest {
    public LibraryService getCleanLibrary() { return new LibraryServiceImpl(new RelatedLibraryPersistenceProviderImpl()); }
